# Golden image srv2019 — vSphere-iso build -> vCenter Content Library.
# Catalogue: os=windows Server 2019 (DC/DNS/DHCP/Exchange/IIS/MSSQL base); base_iso=SERVER_2019_EVAL_x64FRE_en-us.iso; sensor_baked=yes.
# NOTE: Build once - derive role snapshots. Distinct eval ISO from 2022.
...
source "vsphere-iso" "srv2019" {
  ...
  iso_paths = ["[${var.vsphere_datastore}] SERVER_2019_EVAL_x64FRE_en-us.iso"]
...
build {
  sources = ["source.vsphere-iso.srv2019"]
