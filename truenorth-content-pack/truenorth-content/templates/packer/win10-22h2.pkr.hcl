# Golden image win10-22h2 — vSphere-iso build -> vCenter Content Library.
# Catalogue: os=windows 10 22H2 (victim/analyst workstation); base_iso=Win10_Enterprise_Eval_x64.iso; sensor_baked=yes.
# NOTE: Workhorse image. NOTE range alias 'windows-10-ltsc' is LTSC - confirm 22H2 vs LTSC channel.
...
source "vsphere-iso" "win10-22h2" {
  ...
  iso_paths = ["[${var.vsphere_datastore}] Win10_Enterprise_Eval_x64.iso"]
...
build {
  sources = ["source.vsphere-iso.win10-22h2"]
