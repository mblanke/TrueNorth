...
class TestRunScenarioV2:
    ...
    def test_run_scenario_mock(self):
        ...
        with patch("worker.tasks._db_session", return_value=mock_session), \
...
class TestGenerateAAR:
    ...
    def test_generate_aar_mock(self):
        ...
        ExRow = namedtuple("ExRow", ["id", "name", "state", "total_score", "max_score",
                                      "started_at", "completed_at"])
        ObjRow = namedtuple("ObjRow", ["ref_id", "description", "objective_type",
                                        "points", "achieved", "evidence", "achieved_at"])

        mock_ex = ExRow("ex-001", "Test Exercise", "completed", 80, 100,
    ...
    def test_snapshot_range_mock(self):
        ...
        with patch("worker.tasks._db_session", return_value=mock_session), \
            ...
            try:
                ...
                result = snapshot_range(range_id="r-snap-001", snapshot_name="test-snap")
